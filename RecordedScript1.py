...
class TestSuite1():
    ...
    def test_myTest1(self):
        ...
        self.driver.find_element(By.ID, "fname").send_keys("Ashik")
        self.driver.find_element(By.ID, "lname").click()
        self.driver.find_element(By.ID, "lname").click()
        self.driver.find_element(By.ID, "lname").send_keys("Nizam")
        ...
        self.driver.find_element(By.CSS_SELECTOR, "#option > option:nth-child(3)").click()
        ...
        self.driver.find_element(By.ID, "favcolor").send_keys("#607163")
        self.driver.find_element(By.ID, "day").click()
        self.driver.find_element(By.ID, "day").send_keys("2024-06-18")
        ...
        self.driver.find_element(By.ID, "a").send_keys("76")
        ...
        self.driver.find_element(By.NAME, "message").send_keys("My name is billa")
